...
// import { createNewListing, postImages } from "@/app/admin/modals/create-modal/service";
const Create = () => {
  ...
  const uploadImage = async(image,idx)=>{
    if(!image) return
    const tostId = toast.loading(`Image ${idx+1} is being uploaded`)
    ...
    try{
        ...
        toast.success(`Successfully upload ${idx + 1}`)
